[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=19500055&assignment_repo_type=AssignmentRepo)
...
## Результат
<b>Обране завдання:</b><br>
5. Обчислити суму елементів матриці розміром N x M

<b>Головний клас:</b><br>
![matrixSum](image/matrixSum.png)
Цей клас matrixSum містить статичний метод calculateSum, який обчислює суму всіх елементів двовимірного масиву цілих чисел (матриці). Метод перевіряє, чи масив не є порожнім або null, а потім за допомогою функціонального підходу (Arrays.stream) перетворює матрицю в потік окремих чисел і обчислює їх суму без використання циклів.

<b>Детальніше можна ознайомитись за посиланням: <a href="https://ppc-ntu-khpi.github.io/advarrays-35-KabanovskiyI/">Документація</a></b><br>

<b>Результат роботи коду:</b><br>
![matrixSum](image/resultTestMatrix.png)